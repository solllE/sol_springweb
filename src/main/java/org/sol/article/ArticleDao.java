...
public class ArticleDao {
	...
	static final String REMOVE_ARTICLE = "delete from article where articleId=?";
	...
	public int modifyArticle(Article article) {
		return jdbcTemplate.update(MODIFY_ARTICLE, article.getTitle(), 
	...
	public int removeArticle(String articleId) {
		return jdbcTemplate.update(REMOVE_ARTICLE, articleId);
}
}